...
class ShadowShader(
    ...
    private val geometryShader: Int = createShader(geometryShaderSource, GL32.GL_GEOMETRY_SHADER)
    ...
    private val lightDirectionUniform: Int
    ...
    init {
        ...
        lightDirectionUniform = getUniformLocation(lightDirectionName)
        glUseProgram(0)
    }
    ...
    fun use(callback: ActiveShader.() -> Unit) {
        ...
        MemoryStack.stackPush().use {
            val lightDirectionBuffer = it.mallocFloat(4)
    ...
    companion object {
        ...
        val lightDirectionName = "LightDirection"
    }
}
